...
/***************************************************************************************/
/* Funcoes prontas: WriteEntity,ReadFile,CreateFiles,Carrega_EntidadeGeral*/
/* Falta funcoes do HeapSort,remover elemento*/
/***************************************************************************************/
...
void createFiles();//PRONTA!L FUNCAO QUE CRIA OS ARQUIVOS
void writeEntity(char *nome);//PRONTA!L FUNCAO QUE GRAVA ENTIDADES NOS ARQUIVOS
void readFiles();//PRONTA!L FUNCAO QUE LE TODO O ARQUIVO E PRINTA NA TELA
...
tabela findOne(char *nome, int ID);//PRONTA!L FUNCAO QUE RETORNA A ENTIDADE CASO ACHE A CHAVE PRIMARIA
tabela *chargeEntity(char *nome);//PRONTA!L FUNCAO QUE CARREGA O VETOR DE ENTIDADES
void changeEntity(char *nome); //PRONTA!L funcao que altera o valor do ID de um elemento
void removeEntity(char *nome);//FALTA
void heapSort();//FALTA
